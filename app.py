...
def edit():
    db.execute("UPDATE products SET name=:name, description=:des, price=:price WHERE id=:id", 
    name=request.form.get("name"), des=request.form.get("description"), price=request.form.get("price"), id=request.form.get("id"))
    return redirect("/myitems")